...
// const aArr = arr.map(x => Math.pow(2, x));
// return aArr;
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
------------------------------------------------------------------------------------------------ */
// X= The number that is taken in from the arr value and multiplied to the 2nd power.
...
------------------------------------------------------------------------------------------------ */
// X= The value received from the output of arr.map
...
const extractStats = (arr) => arr.map(x => {
  return {
    name: x.stat.name,
